...
const MEMBERS = [
  {
    ...
    bio: "Мария родилась 11 мая 2009 года. Танцует уже почти 10 лет — начинала в группе «Микс» под руководством Н.В. Волковой. Специально для дуэта «Он-лайн» Мария берёт на себя роль хореографа: именно она придумывает движения и создаёт постановки дуэта. Подруги с детского сада — их 13-летняя дружба с Дарьей стала основой общего творчества.",
